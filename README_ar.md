...
• **5 مصادر بيانات، بدون إعداد** — أسهم A، HK/US، العملات المشفرة، العقود الآجلة، الفوركس مع بديل تلقائي<br>
  ...
  <tr>
    <td align="center" width="25%" valign="top">
      ...
      <div align="left" style="font-size: 4px;">
        • 69 مهارة متخصصة مع ذاكرة دائمة عبر الجلسات<br>
...
│   │   │   ├── skills.py           #   محمل المهارات (69 مدمجة + إنشاء CRUD من المستخدم)
